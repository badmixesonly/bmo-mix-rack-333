...
UtilPanel::UtilPanel (ui::ModuleContext ctx)
    : ModulePanel (std::move (ctx)),
      ...
      phaseL (context.params.param (Index::phaseL), ui::BmoLookAndFeel::phaseGlyph() + " L", context.def.accent),
      phaseR (context.params.param (Index::phaseR), ui::BmoLookAndFeel::phaseGlyph() + " R", context.def.accent),
